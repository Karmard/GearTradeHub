...
$query = "SELECT cr.vinNo, cr.carName, cr.frontimage, cr.sideLeftimage, cr.sideRightimage, cr.backimage, cr.dashboardimage, cr.interiorimage, cr.price, cr.transmission, cr.mileage, u.username 
          FROM carreg cr
