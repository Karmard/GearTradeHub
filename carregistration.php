...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    $sql = "INSERT INTO carreg (UserID, vinNo, carName, brand, vehicleType, transmission, carCondition, mileage, frontimage, sideLeftimage, sideRightimage, backimage, interiorimage, dashboardimage, price, registrationDate)
            VALUES ('{$_SESSION['UserID']}', '$vinNo', '$carName', '$brand', '$vehicleType', '$transmission', '$carCondition', '$mileage', '$frontImage', '$sideLeftImage', '$sideRightImage', '$backImage', '$interiorImage', '$dashboardImage', '$price', '$registrationDate')";
